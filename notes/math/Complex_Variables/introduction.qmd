...
Written in the form $a+bi$ with $a, b \in \mathbb{R}$, a is the real part denoted by $\operatorname{R}(z)$. b is the imaginary part, denoted by $\operatorname{I}(z)$. The set of complex numbers can be defined as $$\mathbb{C} = \{a + bi | a, b \in \mathbb{R}\}$$ Taking $z_1 = a + bi$ and $z_2 = c + di$, we can define
